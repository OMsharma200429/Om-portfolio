...
export function AboutSection() {
  return (
    <>
      ...
      <section
        id="about"
        className="relative py-28 md:py-36 px-5 md:px-10 overflow-hidden"
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, rgba(168,85,247,0.04), transparent 60%)",
          }}
        />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <FadeIn y={30} delay={0.15} className="max-w-3xl mx-auto text-center">
            ...
            >
              I&apos;m{" "}
              <span className="accent-gradient font-semibold">Om Sharma</span>,
              a passionate Java Full Stack Developer focused on building
              scalable backend systems and modern web experiences.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {STATS.map((s, i) => (
              <Tilt key={s.label} max={10}>
                ...
                >
                  <div
                    className="font-black accent-gradient"
                    style={{
                      fontSize: s.isText
                        ? "clamp(1.1rem, 2.2vw, 1.8rem)"
                  ...
                  <p className="mt-3 text-white/60 uppercase tracking-wider text-xs md:text-sm">
                    {s.label}
                  </p>
                </motion.div>
              </Tilt>
          ...
          >
            <a
              href="/resume/OM_SHARMA_Resume.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-white font-medium uppercase tracking-wider text-sm glow"
              style={{
          ...
          <FadeIn y={30} delay={0.15}>
            <Tilt max={8}>
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="glass gradient-border rounded-2xl p-7 md:p-10 max-w-3xl mx-auto text-center"
              >
                ...
                <div className="mt-6 inline-flex items-center rounded-full border border-purple-400/20 bg-purple-500/10 px-5 py-2">
